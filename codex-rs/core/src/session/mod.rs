...
impl Session {
    ...
    pub(crate) async fn build_initial_context_without_side_effects(
        ...
        let world_state = self.build_world_state_for_step(&step_context).await;
        self.build_initial_context_with_world_state_and_mcp_inner(
            turn_context.as_ref(),
            &world_state,
    ...
    async fn build_initial_context_with_world_state_and_mcp_inner(
        &self,
        turn_context: &TurnContext,
        world_state: &WorldState,
        mcp: &McpRuntimeSnapshot,
