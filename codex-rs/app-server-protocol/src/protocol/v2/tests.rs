...
fn config_granular_approval_policy_is_marked_experimental() {
    let reason = crate::experimental_api::ExperimentalApi::experimental_reason(&Config {
        ...
        rolling_context_reserve_percent: None,
        rolling_context_target_tokens: None,
        rolling_compaction: None,
        protected_hot_exact_tokens: None,
        summary_group_token_cap: None,
        max_summary_levels: None,
        compact_when_level_group_count_gt: None,
        model_provider: None,
